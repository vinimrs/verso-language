...
public class VersoUtils {
    ...
    // Adiciona um erro semântico à lista e informa a linha onde foi encontrado, dado um token e a mensagem como parâmetros
    public static void addSemanticError(Token t, String mensagem) {
        int linha = t.getLine();
        errosSemanticos.add(String.format("Linha %d: %s", linha, mensagem));
    }

    // Verifica o tipo de um símbolo presente em uma SymbolsTable considerando um elemento de layout (por exemplo, uma seção ou parágrafo)
    ...
    // Verifica o tipo de um símbolo presente em uma SymbolsTable considerando um atributo de um elemento (por exemplo, 'alt' em uma imagem ou 'href' em um link)
    ...
    // Verifica o tipo de um símbolo presente em uma SymbolsTable considerando uma string de identificador
    ...
    // Verifica a estrutura de um símbolo presente em uma SymbolsTable considerando uma string de identificador
